              ...
              children: <Widget>[
                ...
                child: Row(
                  children: <Widget>[
                    ...
                    Container(width:100, padding: EdgeInsets.only(top: 0.0, bottom: 0.0), child: Text('Best', textAlign: TextAlign.center, style: TextStyle(fontSize: 16))),
                    Container(width:100, padding: EdgeInsets.only(top: 0.0, bottom: 0.0), child: Text('Previous', textAlign: TextAlign.center, style: TextStyle(fontSize: 16))),
                    Container(width: 100, padding: EdgeInsets.only(top: 0.0, bottom: 0.0), child: Text('Current', textAlign: TextAlign.center, style: TextStyle(fontSize: 16))),
                    Expanded(flex: 1, child: Container(height: 5)),
                  ],
                ),
              ),
              Container(padding: EdgeInsets.only(top: 0.0, bottom: 0.0),
                child: Row(
                  children: <Widget>[
                    ...
                    Container( width:100, padding: EdgeInsets.only(top: 0.0, bottom: 0.0), child: Text(bestVolume.toString(), textAlign: TextAlign.center, style: TextStyle(fontSize: 16))),
                    Container( width:100, padding: EdgeInsets.only(top: 0.0, bottom: 0.0), child: Text(previousVolume.toString(), textAlign: TextAlign.center, style: TextStyle(fontSize: 16))),
                    Container(width: 100, padding: EdgeInsets.only(top: 0.0, bottom: 0.0), child: Text(currentVolume.toString(), textAlign: TextAlign.center, style: TextStyle(fontSize: 16))),
                    Expanded(flex: 1, child: Container(height: 10)),
                  ],
                ),
              ),
              Container(
                ...
                child: Row(
                  children: <Widget>[
                    ...
                    Container(width: 90, padding: EdgeInsets.only(top: 0.0, bottom: 0.0), child: Text('Weight', textAlign: TextAlign.center, style: TextStyle(fontSize: 16))),
                    Container(width: 90, padding: EdgeInsets.only(top: 0.0, bottom: 0.0),child: Text('Sets', textAlign: TextAlign.center, style: TextStyle(fontSize: 16))),
                    Container(width: 90, padding: EdgeInsets.only(top: 0.0, bottom: 0.0), child: Text('Reps', textAlign: TextAlign.center, style: TextStyle(fontSize: 16))),
                    Expanded(flex: 1, child: Container(height: 0)),
                  ],
                ),
              ),
                              ...
                              child: new IconButton(
                                ...
                                onPressed: () {
                                  ...
                                  Provider.of<TodosModel>(context, listen: false).updateRound(_round);
                                   currentVolume = 0;
                                  _rounds.forEach((round) { currentVolume += (round.weight * round.round * round.rep); });
                                  Provider.of<TodosModel>(context, listen: false).updateExercise(Exercise(
                                    id: _exercise.id, 
                                    name: _exercise.name, 
                                    completed: _exercise.completed, 
                              ...
                              child: new IconButton(
                                ...
                                onPressed: () {    
                                  ...
                                  _rounds.forEach((round) {
                                    currentVolume += (round.weight * round.round * round.rep);
                                  });
                                  Provider.of<TodosModel>(context, listen: false).updateExercise(Exercise(
                                    id: _exercise.id, 
                                    name: _exercise.name, 
